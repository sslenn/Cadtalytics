...
class UndergraduateStudent(Student):
    def __init__(self, student_id, name, age, year_level, major,
                 study_time = 2, absences = 5, internet_usage = 4.0,
                 extra_classes = 0, sleep_hours = 7.0, parent_education = 2):
        
        # inheritance from parent(Student)
        super().__init__(student_id, name, age, year_level,
                         study_time, absences, internet_usage,
                         extra_classes, sleep_hours, parent_education)
        self.major = major
    ...
    def generate_report(self):
        return (
            ...
            f"Extra class:                        {'yes' if self.extra_classes else 'No'}\n"
...
class GraduateStudent(Student):
    def __init__(self, student_id, name, age, year_level, thesis_topic,
                 study_time = 2, absences = 5, internet_usage = 4.0,
                 extra_classes = 0, sleep_hours = 7.0, parent_education = 2):
